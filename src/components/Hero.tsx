        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="https://wa.me/918827672003" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-white hover:bg-stone-50 text-emerald-600 border-2 border-emerald-600 px-8 py-4 rounded-full font-medium text-lg transition-all hover:-translate-y-0.5">
